...
- Uber Pay emerged as the most preferred payment method.
...
- UberX generated the highest booking volume and overall revenue.
- Premium vehicle categories achieved higher average booking values.
- Vehicle demand varied across different locations and time periods.

### 📌 Time-Based Insights

- Booking activity gradually increased during the morning hours.
- Peak demand occurred during the afternoon and evening.
- Heatmap analysis highlighted the busiest booking hours throughout the week.

### 📌 Location Insights

- Penn Station/Madison Square was the most frequent pickup location.
- Upper East Side North was the most common drop-off destination.
- A few high-demand zones contributed to a significant share of total bookings.
...
>(https://github.com/chirag1437/uber-trip-analysis-powerbi/blob/main/Screenshot%202026-07-22%20155923.png)
